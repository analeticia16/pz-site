      ...
      <main className="container max-w-screen-2xl py-4">
        ...
        <section id="contato" className="py-16">
          <div className="mt-16 grid grid-cols-3 grid-rows-2 gap-12">
            {[1, 2].map((n) => (
              <>
                <div className="rounded bg-slate-50 py-8">
                  <img
                ...
                <div className="rounded bg-slate-50 py-8">
                  <img
                    src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80"
                    alt="parceira"
                    className="mx-auto h-64 w-64 rounded-full object-cover"
                  />
                  <h3 className="mt-6 text-center text-lg font-semibold text-black">
